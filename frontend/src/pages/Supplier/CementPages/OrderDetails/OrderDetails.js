    ...
    const orderAccepted = async (id) => {
        try{
            ...
            if (success) {
                ...
                setTimeout(() => {
                    navigate('/supplier/cement/pending-orders');
                }, 500);
            } else if (error) {
    ...
    const orderCompleted = async (id) => {
        try{
            ...
            if (success) {
                ...
                setTimeout(() => {
                    navigate('/supplier/cement/under-preparing-orders');
                }, 500);
            } else if (error) {
                const details = error?.details[0].message;
                handleError(details);
            ...
            {orders ? (
                <div className={styles.orderContainer}>
                    <div className={styles.orderRow}> 
                        ...
                        <div className={styles.orderDiv}>
                            <p className={styles.orderData}>
                                <strong>Cement quantity:</strong> {orders.cementQuantity} ton
                            </p>
                            <p className={styles.orderData}>
                                <strong>Number of cement bags:</strong> {orders.cementNumberBags} 
                            </p>
                            <p className={styles.orderData}>
